...
Superseded in part by ADR 0018: the no-JS fallback this assumed is gone, and the UI now requires JavaScript. The section-swap mechanism and the vendored-htmx decision below still stand.
